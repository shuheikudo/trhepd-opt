...
!**********************************************************
        ...
        implicit none
        integer, intent(in) :: nsg, nv,ma,mb,na,nb
        real(8), intent(in) :: gh(nv),gk(nv),x,y,dx,dy
        complex(8), intent(out) :: st(nv)
        ! local variables
        integer :: ndeg, m, i
        real(8) :: s, gr, xs(12),ys(12),xb(12),yb(12)
        real(8) :: reduce01
...
! (x,y) 1x1 lattice --> (xs,ys) surface lattice
        ...
        if (nsg < 1 .or. nsg > 17) then ! p1
          call abort !"nsg must be one of 1...17"
        else if (nsg == 1) then
          ndeg = 1
        else if (nsg == 2) then
...
!**********************************************************
        ...
        implicit none
        integer, intent(out) :: ndeg
        real(8), intent(inout) :: xs(12), ys(12)
        real(8) :: x, y
