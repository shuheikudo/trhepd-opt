            ...
            do igr=1,ngr
              ...
              do l=1,ns
                ...
                if (ns == 1) then
                  ...
                  call zgemm('N', 'N', nbf2, nbf2, nbf2, (1d0,0d0), t1, nbgm2, t4, nbgm2, (0d0,0d0), t3, nbgm2)
              ...
              do l=1,ml
                t1(1:nbf,1:nbf) = t3(1:nbf,(nbf+1):(nbf+nbf))
                t2(1:nbf,1:nbf) = t3((nbf+1):(nbf+nbf),(nbf+1):(nbf+nbf))
                if(l>1)then
                  call zgemm('N', 'N', nbf, nbf, nbf, (1d0,0d0), t3, nbgm2, t4, nbgm2, (1d0,0d0), t1, nbgm2)
                  call zgemm('N', 'N', nbf, nbf, nbf, (1d0,0d0), t3(nbf+1,1), nbgm2, t4, nbgm2, (1d0,0d0), t2, nbgm2)
                end if
                call gcmi3(nbgm2,nbf,t1,t2)
